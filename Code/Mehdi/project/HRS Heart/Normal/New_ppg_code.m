...
print(gcf,'Raw HRS and Filtered HRS - Heart - Normal','-depsc');
saveas(gcf,'Raw HRS and Filtered HRS - Heart - Normal.png')
%% Periodogram
...
print(gcf,'Periodogram of Filtered HRS - Heart - Normal','-depsc');
saveas(gcf,'Periodogram of Filtered HRS - Heart - Normal.png')
...
print(gcf,'FFT of Filtered HRS - Heart - Normal','-depsc');
saveas(gcf,'FFT of Filtered HRS - Heart - Normal.png')
...
figure
plot((1:t)/100,y1)
print(gcf,'Windowed HRS - Heart - Normal','-depsc');
saveas(gcf,'Windowed HRS - Heart - Normal - Heart - Normal.png')
