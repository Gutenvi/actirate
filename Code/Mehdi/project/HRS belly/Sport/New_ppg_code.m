...
print(gcf,'Raw HRS and Filtered HRS - Belly - Sport','-depsc');
saveas(gcf,'Raw HRS and Filtered HRS - Belly - Sport.png')
%% Periodogram
...
print(gcf,'Periodogram of Filtered HRS - Belly - Sport','-depsc');
saveas(gcf,'Periodogram of Filtered HRS - Belly - Sport.png')
...
print(gcf,'FFT of Filtered HRS - Belly - Sport','-depsc');
saveas(gcf,'FFT of Filtered HRS - Belly - Sport.png')
...
figure
plot((1:t)/100,y1)
print(gcf,'Windowed HRS - Belly - Sport','-depsc');
saveas(gcf,'Windowed HRS - Belly - Sport - Belly - Sport.png')
