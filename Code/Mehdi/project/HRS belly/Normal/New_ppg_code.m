...
print(gcf,'Raw HRS and Filtered HRS - Belly - Normal','-depsc');
saveas(gcf,'Raw HRS and Filtered HRS - Belly - Normal.png')
%% Periodogram
...
print(gcf,'FFT of Filtered HRS - Belly - Normal','-depsc');
saveas(gcf,'FFT of Filtered HRS - Belly - Normal.png')
...
xlabel('Time (s)');
ylabel('BPMs');
print(gcf,'Windowed HRS - Belly - Normal','-depsc');
saveas(gcf,'Windowed HRS - Belly - Normal - Belly - Normal.png')
